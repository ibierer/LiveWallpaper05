...
public:
    ...
    string computeShaderCode[1000] = {
            ...
            "                                    for (uint index = 0u; index < outBuffer.pCells[homeCell].numCellParticles; index++) {\n",
            "                                        vec3 pxyz = outBuffer.pCells[homeCell].positions[index];\n",
            ...
            "                                                    uint cellNr = (xi * pNumY + yi) * pNumZ + zi;\n",
            "                                                    uint last = outBuffer.pCells[cellNr].numCellParticles;\n",
            "                                                    for (uint j = 0u; j < last; j++) {\n",
            "                                                        uint id = outBuffer.pCells[cellNr].indices[j];\n",
            "                                                        if (id == outBuffer.pCells[homeCell].indices[index])\n",
            "                                                            continue;\n",
            "                                                        vec3 dxyz = outBuffer.pCells[cellNr].positions[j] - pxyz;\n",
            ...
            "                                                        dxyz *= _s;\n",
            "                                                        outBuffer.pCells[homeCell].positions[index] -= dxyz;\n",
            "                                                        outBuffer.pCells[cellNr].positions[j] += dxyz;\n",
            "                                                    }\n",
            "                                                }\n",
            "                                            }\n",
            "                                        }\n",
