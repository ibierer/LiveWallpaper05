...
Java_com_xendovo_PreviewActivity_00024Companion_init(JNIEnv *env, jobject thiz, jstring JSON, jint mode) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_xendovo_PreviewActivity_00024Companion_resize(JNIEnv *env, jobject thiz, jint width, jint height, jint mode) {
    if (view[mode]) {
...
Java_com_xendovo_PreviewActivity_00024Companion_getScreenBuffer(JNIEnv *env, jobject thiz, jint mode) {
