...
Graph3View::Graph3View(const int &particleCount, const bool &fluidSurface, const int &graphSize, const float &sphereRadius, const bool &referenceFrameRotates, const bool &smoothSphereSurface) : View() {
...
Graph3View::~Graph3View(){
    glDeleteProgram(mProgram);
    delete simulation.particles;
}

void Graph3View::render(){
